  ...
  return (
    <div className="my-20">
      <div className={`${style.flexColCenterAlignCenter} pb-20`}>
        <HeadingThree headingTitle={"Meet With Our Expert Team"} />
        <HeadingOne headingTitle={"Timtom Aviation Instructors"} />
        <Pragraph pragraphContent={" They are our expert instructors who work hard night and day to grow our\
          business worldwide. "} />
