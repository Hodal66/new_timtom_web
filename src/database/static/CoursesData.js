export const CourseData = [
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of licensing requirements and procedures for aviation personnel.",
      },
      {
        id: 2,
        courseHeading: "International Licensing Standards",
        courseSubHeadingInfo:
          "Learn international aviation personnel licensing standards and regulations.",
      },
      {
        id: 3,
        courseHeading: "Compliance and Licensing Renewals",
        courseSubHeadingInfo:
          "Master the process of renewing licenses and ensuring compliance with aviation regulations.",
      },
      {
        id: 4,
        courseHeading: "Licensing Compliance Management",
        courseSubHeadingInfo:
          "Understand how to manage and maintain compliance with licensing standards in aviation.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of SMS principles and their importance in aviation.",
      },
      {
        id: 2,
        courseHeading: "Hazard Identification and Risk Management",
        courseSubHeadingInfo:
          "Learn how to identify hazards and assess risks in aviation operations.",
      },
      {
        id: 3,
        courseHeading: "Safety Audits and Compliance",
        courseSubHeadingInfo:
          "Understand how to conduct safety audits and ensure regulatory compliance.",
      },
      {
        id: 4,
        courseHeading: "Safety Risk Mitigation Strategies",
        courseSubHeadingInfo:
          "Develop strategies to mitigate safety risks in aviation operations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of the USOAP Continuous Monitoring Approach and its importance.",
      },
      {
        id: 2,
        courseHeading: "Audit Preparation and Safety Oversight",
        courseSubHeadingInfo:
          "Learn how to prepare for audits and ensure safety oversight compliance.",
      },
      {
        id: 3,
        courseHeading: "Audit Procedures and Compliance",
        courseSubHeadingInfo:
          "Detailed analysis of audit procedures, safety compliance, and corrective actions.",
      },
      {
        id: 4,
        courseHeading: "Reporting and Post-Audit Actions",
        courseSubHeadingInfo:
          "Understand the reporting process and corrective action plans post-audit.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of aviation management principles and their importance.",
      },
      {
        id: 2,
        courseHeading: "Airport and Airline Operations",
        courseSubHeadingInfo:
          "Learn how to manage daily operations of airports and airlines.",
      },
      {
        id: 3,
        courseHeading: "Safety and Regulatory Compliance",
        courseSubHeadingInfo:
          "Understand the regulatory requirements and safety standards in aviation.",
      },
      {
        id: 4,
        courseHeading: "Resource and Personnel Management",
        courseSubHeadingInfo:
          "Gain insights into managing resources and personnel in aviation.",
      },
      {
        id: 5,
        courseHeading: "Global Aviation Trends",
        courseSubHeadingInfo:
          "Learn about the latest global trends impacting the aviation industry.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of the core functions and roles within airport operations.",
      },
      {
        id: 2,
        courseHeading: "Passenger Services and Logistics",
        courseSubHeadingInfo:
          "Learn the principles of passenger handling, cargo logistics, and security procedures.",
      },
      {
        id: 3,
        courseHeading: "Safety and Regulatory Compliance",
        courseSubHeadingInfo:
          "Understand how to ensure safety and compliance with aviation regulations in an airport environment.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of ground handling operations and key responsibilities.",
      },
      {
        id: 2,
        courseHeading: "Baggage and Cargo Handling",
        courseSubHeadingInfo:
          "Learn the principles of managing baggage and cargo logistics at airports.",
      },
      {
        id: 3,
        courseHeading: "Aircraft Servicing and Safety",
        courseSubHeadingInfo:
          "Understand the procedures for aircraft servicing, safety, and compliance with aviation regulations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of the airline industry's unique marketing challenges and strategies.",
      },
      {
        id: 2,
        courseHeading: "Brand Positioning and Market Segmentation",
        courseSubHeadingInfo:
          "Learn how to position an airline brand and segment the market effectively.",
      },
      {
        id: 3,
        courseHeading: "Passenger Loyalty and Retention",
        courseSubHeadingInfo:
          "Understand how to build and manage passenger loyalty programs for long-term success.",
      },
      {
        id: 4,
        courseHeading: "Digital and Social Media Marketing for Airlines",
        courseSubHeadingInfo:
          "Learn how to use digital marketing tools to engage customers and promote airline services.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of cabin crew responsibilities and requirements.",
      },
      {
        id: 2,
        courseHeading: "Safety and Emergency Procedures",
        courseSubHeadingInfo:
          "Learn key safety protocols, emergency evacuations, and passenger safety procedures.",
      },
      {
        id: 3,
        courseHeading: "In-Flight Customer Service",
        courseSubHeadingInfo:
          "Understand how to deliver excellent customer service and ensure passenger comfort.",
      },
      {
        id: 4,
        courseHeading: "Regulations and Compliance",
        courseSubHeadingInfo:
          "Learn about the regulations and standards for cabin crew operations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Overview of fare structures and ticketing procedures in the aviation industry.",
      },
      {
        id: 2,
        courseHeading: "Using Amadeus for Flight Reservations",
        courseSubHeadingInfo:
          "Learn how to use the Amadeus GDS for creating and managing flight bookings.",
      },
      {
        id: 3,
        courseHeading: "Fare Calculation and Ticketing",
        courseSubHeadingInfo:
          "Master fare rules, calculations, and ticket issuance using Amadeus.",
      },
      {
        id: 4,
        courseHeading: "Managing Changes, Refunds, and Reissues",
        courseSubHeadingInfo:
          "Learn how to manage ticket modifications, refunds, and reissues efficiently in Amadeus.",
      },
    ],
  },
  {
    ...
    coursePackage: [
      ...
      "3. Airline and Airport Marketing",
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Master the core functions of managing daily airport operations with a focus on logistics and passenger handling.",
      },
      {
        id: 2,
        courseHeading: "Ground Handling and Safety Compliance",
        courseSubHeadingInfo:
          "Learn the roles and responsibilities involved in managing ground handling services, including aircraft servicing, baggage, and cargo logistics.",
      },
      {
        id: 3,
        courseHeading: "Airline Marketing Strategies",
        courseSubHeadingInfo:
          "Understand how airlines use strategic marketing to attract and retain customers, focusing on brand positioning and loyalty programs.",
      },
      {
        id: 4,
        courseHeading: "Safety and Regulatory Frameworks",
        courseSubHeadingInfo:
          "Learn about the safety protocols and regulatory standards that airports and airlines must comply with.",
      },
      {
        id: 5,
        courseHeading: "Customer Service and Operational Efficiency",
        courseSubHeadingInfo:
          "Learn how to balance operational efficiency with high-quality customer service in airline and airport management.",
      },
      {
        id: 6,
        courseHeading: "Resource and Personnel Management",
        courseSubHeadingInfo:
          "Gain insights into effective resource and personnel management within the framework of ground operations and marketing.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the core functions and processes involved in air cargo handling, focusing on safety and efficiency.",
      },
      {
        id: 2,
        courseHeading: "Dangerous Goods Management",
        courseSubHeadingInfo:
          "Understand the principles of handling and transporting dangerous goods, including packaging, labeling, and safety regulations.",
      },
      {
        id: 3,
        courseHeading: "Logistics and Supply Chain Management",
        courseSubHeadingInfo:
          "Learn the logistics processes involved in air cargo, including coordination, customs clearance, and freight forwarding.",
      },
      {
        id: 4,
        courseHeading: "Air Cargo Documentation and Compliance",
        courseSubHeadingInfo:
          "Gain insights into cargo documentation, compliance with international regulations, and customs clearance procedures.",
      },
      {
        id: 5,
        courseHeading: "Optimizing Air Cargo Operations",
        courseSubHeadingInfo:
          "Learn how to improve operational efficiency in air cargo handling, optimizing cargo space and ensuring safety.",
      },
      {
        id: 6,
        courseHeading: "International Freight and Supply Chain Coordination",
        courseSubHeadingInfo:
          "Understand the global supply chain and the role of air cargo in international logistics and freight management.",
      },
    ],
  },
  {
    ...
    houMuchToGetCeriticate: 75,
    coursePackage: [
      "1. Travel and Tourism Faundation",
      "2. Air Ticketing and Fare Calculations",
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the basics of travel and tourism management, including customer service, travel planning, and the travel ecosystem.",
      },
      {
        id: 2,
        courseHeading: "Air Ticketing and Fare Calculations",
        courseSubHeadingInfo:
          "Master the process of ticketing and fare calculations for various types of travel, including domestic and international flights.",
      },
      {
        id: 3,
        courseHeading: "Travel Consultancy and Client Management",
        courseSubHeadingInfo:
          "Learn how to offer expert travel consultancy services, manage clients, and create tailored travel plans.",
      },
      {
        id: 4,
        courseHeading: "Visa and Travel Documentation",
        courseSubHeadingInfo:
          "Understand how to handle visa applications, travel documents, and ensure compliance with international regulations.",
      },
      {
        id: 5,
        courseHeading: "Tourism Trends and Global Travel",
        courseSubHeadingInfo:
          "Gain insights into global tourism trends and how they impact travel consultancy and agency management.",
      },
      {
        id: 6,
        courseHeading: "Managing Travel Agencies",
        courseSubHeadingInfo:
          "Learn how to manage the operations of travel agencies, focusing on customer service and efficient travel management.",
      },
    ],
  },
  {
    ...
    coursePackage: [
      ...
      "2. Aviation Security",
      "3. Aviation Legal Environment and Crew Resourses Managment",
      "4. Ground Operation Management",
    ],
    smallDescription:
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the core principles of safety management systems (SMS) and their importance in aviation.",
      },
      {
        id: 2,
        courseHeading: "Aviation Security Protocols",
        courseSubHeadingInfo:
          "Understand how to implement and manage security operations in airports and airlines.",
      },
      {
        id: 3,
        courseHeading: "Aviation Legal Environment",
        courseSubHeadingInfo:
          "Gain knowledge of the legal frameworks governing aviation safety and security.",
      },
      {
        id: 4,
        courseHeading: "Crew Resource Management (CRM)",
        courseSubHeadingInfo:
          "Learn how to manage and coordinate crew members to enhance safety and operational efficiency.",
      },
      {
        id: 5,
        courseHeading: "Ground Operations Safety and Security",
        courseSubHeadingInfo:
          "Learn how to manage ground operations with a focus on safety, security, and operational excellence.",
      },
      {
        id: 6,
        courseHeading: "Regulatory Compliance and Safety Audits",
        courseSubHeadingInfo:
          "Understand how to conduct safety audits and ensure compliance with aviation regulations.",
      },
    ],
  },
  {
    ...
    coursePackage: [
      "1. Airport Operation Certification",
      "2. Auditing Techinical in CAA",
      "3. USOAP CMA Audit",
      "4. AirCraft Operation",
      "5. Aviation Legal Environment",
      "6. Personal Licensing",
      "7. Commercial and Aviation Law",
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the requirements and processes for obtaining airport operator certification, including compliance with international standards.",
      },
      {
        id: 2,
        courseHeading: "Auditing Technical in CAA",
        courseSubHeadingInfo:
          "Gain expertise in auditing technical operations within civil aviation authorities, ensuring safety and regulatory compliance.",
      },
      {
        id: 3,
        courseHeading: "USOAP CMA Audit",
        courseSubHeadingInfo:
          "Master the USOAP CMA audit framework and how to apply it to ensure aviation safety and regulatory compliance.",
      },
      {
        id: 4,
        courseHeading: "Aircraft Operations Management",
        courseSubHeadingInfo:
          "Learn how to manage aircraft operations, focusing on scheduling, safety, and logistics.",
      },
      {
        id: 5,
        courseHeading: "Aviation Legal Environment and Commercial Law",
        courseSubHeadingInfo:
          "Understand the legal and regulatory frameworks governing aviation, including commercial law and its impact on operations.",
      },
      {
        id: 6,
        courseHeading: "Personnel Licensing and Compliance",
        courseSubHeadingInfo:
          "Learn the procedures and international standards for licensing aviation personnel, ensuring compliance with regulatory bodies.",
      },
      {
        id: 7,
        courseHeading: "Aircraft Maintenance Management",
        courseSubHeadingInfo:
          "Gain expertise in managing aircraft maintenance, ensuring safety, compliance, and operational efficiency.",
      },
      {
        id: 8,
        courseHeading: "Safety and Regulatory Compliance",
        courseSubHeadingInfo:
          "Learn how to conduct safety audits and ensure compliance with international aviation regulations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn how to implement safety protocols and manage emergency situations as part of the cabin crew.",
      },
      {
        id: 2,
        courseHeading: "Cabin Crew Operations and Responsibilities",
        courseSubHeadingInfo:
          "Master the roles and responsibilities of cabin crew members, focusing on passenger safety and in-flight services.",
      },
      {
        id: 3,
        courseHeading: "Passenger Handling and Customer Service",
        courseSubHeadingInfo:
          "Learn how to manage passenger interactions, handle emergencies, and deliver high-quality in-flight services.",
      },
      {
        id: 4,
        courseHeading: "Aviation Security for Cabin Crew",
        courseSubHeadingInfo:
          "Understand how to implement aviation security protocols, ensuring the safety of passengers and crew from potential threats.",
      },
      {
        id: 5,
        courseHeading: "Emergency Procedures and Crisis Management",
        courseSubHeadingInfo:
          "Gain practical experience in managing emergencies, including evacuations and in-flight crisis situations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseHeading: "Introduction to Airport Operations",
        courseSubHeadingInfo:
          "Learn the core functions of managing airport operations, focusing on logistics and safety.",
      },
      {
        id: 2,
        courseHeading: "Passenger Services and Processing",
        courseSubHeadingInfo:
          "Master the principles of passenger services, including check-in, security, and customer service.",
      },
      {
        id: 3,
        courseHeading: "Airport Logistics and Ground Handling",
        courseSubHeadingInfo:
          "Gain insights into managing airport logistics, including baggage handling, cargo operations, and ground handling services.",
      },
      {
        id: 4,
        courseHeading: "Safety Protocols and Compliance",
        courseSubHeadingInfo:
          "Understand the critical safety protocols and compliance requirements for airport operations.",
      },
      {
        id: 5,
        courseHeading: "Coordination of Airport Services",
        courseSubHeadingInfo:
          "Learn how to coordinate various airport services, including security, ground services, and passenger processing.",
      },
      {
        id: 6,
        courseHeading: "IATA Standards and Global Regulations",
        courseSubHeadingInfo:
          "Understand the international standards and regulations that govern airport operations under IATA.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the basics of the travel and tourism industry, focusing on customer service and travel planning.",
      },
      {
        id: 2,
        courseHeading: "Air Ticketing and Fare Calculations",
      ...
      },
      {
        ...
        courseSubHeadingInfo:
          "Learn the techniques required to deliver excellent customer service in travel agencies and tourism organizations.",
      },
      {
        id: 4,
        courseHeading: "Global Tourism Trends",
        courseSubHeadingInfo:
          "Gain insights into global tourism trends and how they impact travel management and customer behavior.",
      },
      {
        id: 5,
        courseHeading: "Travel Operations and Itinerary Planning",
        courseSubHeadingInfo:
          "Understand how to manage travel operations, including creating and managing customer itineraries.",
      },
      {
        id: 6,
        courseHeading: "Travel Documentation and Visa Processes",
        courseSubHeadingInfo:
          "Learn the procedures for managing travel documentation, including visas and international travel regulations.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the key components of the aviation industry, including airlines, airports, and aviation authorities.",
      },
      {
        id: 2,
        courseHeading: "Airline Operations and Management",
        courseSubHeadingInfo:
          "Gain insights into the operational structure of airlines, including flight operations, scheduling, and customer service.",
      },
      {
        id: 3,
        courseHeading: "Airport Operations and Management",
        courseSubHeadingInfo:
          "Understand how airports operate, including terminal management, ground services, and passenger handling.",
      },
      {
        id: 4,
        courseHeading: "Aviation Safety and Compliance",
        courseSubHeadingInfo:
          "Learn the core principles of aviation safety and how to ensure compliance with international regulations.",
      },
      {
        id: 5,
        courseHeading: "IATA Regulations and Global Standards",
        courseSubHeadingInfo:
          "Understand the global regulatory frameworks, including IATA standards, that guide aviation operations.",
      },
      {
        id: 6,
        courseHeading: "Operational Efficiency in Aviation",
        courseSubHeadingInfo:
          "Learn how to optimize airline and airport operations for efficiency while maintaining high safety standards.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the roles and responsibilities of air cabin crew members, focusing on safety and service.",
      },
      {
        id: 2,
        courseHeading: "In-Flight Passenger Handling and Customer Service",
        courseSubHeadingInfo:
          "Master the techniques for handling passengers, delivering customer service, and managing in-flight requests.",
      },
      {
        id: 3,
        courseHeading: "Aviation Safety and Emergency Procedures",
        courseSubHeadingInfo:
          "Understand the safety protocols and emergency procedures required to ensure passenger and crew safety during flights.",
      },
      {
        id: 4,
        courseHeading: "Aviation Security and Regulatory Compliance",
        courseSubHeadingInfo:
          "Learn the international aviation security regulations and how to ensure compliance with safety standards.",
      },
      {
        id: 5,
        courseHeading: "Communication and Teamwork in Cabin Crew",
        courseSubHeadingInfo:
          "Develop the communication and teamwork skills necessary for working effectively as part of a cabin crew team.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the basic principles of air cargo logistics, handling, and transportation.",
      },
      {
        id: 2,
        courseHeading: "Air Cargo Documentation and Compliance",
        courseSubHeadingInfo:
          "Master the regulatory requirements and documentation needed for efficient air cargo operations.",
      },
      {
        id: 3,
        courseHeading: "Freight Forwarding and Global Supply Chain",
        courseSubHeadingInfo:
          "Gain insights into the role of freight forwarding in the global supply chain and how to manage it effectively.",
      },
      {
        id: 4,
        courseHeading: "Cargo Safety and Security",
        courseSubHeadingInfo:
          "Learn the safety protocols and security measures required for handling air cargo, including dangerous goods.",
      },
      {
        id: 5,
        courseHeading: "Handling Special Cargo",
        courseSubHeadingInfo:
          "Understand the procedures for handling special types of cargo, such as perishable items and hazardous materials.",
      },
      {
        id: 6,
        courseHeading: "Cargo Operations and Tracking Systems",
        courseSubHeadingInfo:
          "Learn how to manage cargo operations efficiently, including loading, unloading, and using cargo tracking systems.",
      },
    ],
  },
  {
    ...
    courseContents: [
      {
        ...
        courseHeading: "Introduction to USOAP CMA",
        courseSubHeadingInfo:
          "Learn about ICAO’s USOAP, the critical elements of aviation safety, and the Continuous Monitoring Approach (CMA).",
      },
      {
        id: 2,
        courseHeading: "Auditing Basics",
        courseSubHeadingInfo:
          "Gain insights into auditing techniques, time management, communication, and team-building for audit missions.",
      },
      {
        id: 3,
        courseHeading: "USOAP Audit Tools and Processes",
        courseSubHeadingInfo:
          "Understand the tools and processes used during ICAO safety audits, focusing on compliance with global standards.",
      },
      {
        id: 4,
        courseHeading: "ICVM Modules",
        courseSubHeadingInfo:
          "Learn about the ICAO Coordinated Validation Missions, including pre-mission, on-site, and post-mission phases.",
      },
      {
        id: 5,
        courseHeading: "Final Exam",
        courseSubHeadingInfo:
          "Pass the Phase I final exam to progress to more specialized audit areas in Phase II.",
      },
    ],
  },
  {
    ...
    imageAlt: "Aviation Security Awareness Course",
    category: "airlineAndAirport",
    subCategory: "aviationSecurity",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 40,
    lastUpdated: "Any Time",
    availability: "On Campus",
    ...
    duration: 1,
    startDate: "Any Time",
    subCoursesUnllorment: 15,
    lectures: 3,
    skillsLevel: "Beginner",
    numberOfQuizes: 1,
    typeOfCetificate: "Local Certificate",
    isCertificateOffered: "Yes",
    houMuchToGetCeriticate: 50,
    coursePackage: [""],
    smallDescription:
      "Learn the essentials of aviation security, focusing on awareness, protocols, and regulatory compliance.",
    money: "150",
    role: "This course equips students with knowledge of aviation security measures, emphasizing awareness of potential threats, security protocols, and international regulatory compliance.",
    mainPragrapContents:
      "The Aviation Security Awareness course provides an in-depth understanding of airport security operations, threat awareness, and the implementation of safety procedures in compliance with international aviation standards.",
    teacher: {
      name: "KAMIKAZI Peace",
      profilePicture: "/images/teamMember/Peace.png",
      bio: "Expert in aviation security with a focus on international regulations and safety protocols.",
      email: "peacek@gmail.com",
      whatSapp: "+250788123456",
      facebook: "peacek",
      instagram: "peacek",
      linkedIn: "kamikazi-peace-123456",
      twitter: "peacek1",
    },
    aboutCourses: [
      "Understand the fundamentals of aviation security awareness.",
      "Learn about international regulations governing aviation security.",
      "Master the identification of potential threats in aviation.",
      "Gain insights into the roles and responsibilities of aviation security personnel.",
      "Learn about the latest trends and technologies in aviation security.",
      "Understand how to apply security protocols in real-world scenarios.",
    ],
    benefitsOfTheCourse: [
      "Develop a strong foundation in aviation security awareness.",
      "Gain knowledge of international security regulations.",
      "Understand the role of technology in aviation security.",
      "Learn how to identify and mitigate potential threats.",
      "Prepare for a career in aviation security operations.",
      "Enhance your understanding of security protocols and compliance.",
    ],
    courseContents: [
      {
        id: 1,
        courseHeading: "Introduction to Aviation Security",
        courseSubHeadingInfo:
          "Learn the basics of aviation security awareness, including threat identification and safety protocols.",
      },
      {
        id: 2,
        courseHeading: "International Security Regulations",
        courseSubHeadingInfo:
          "Understand the international standards and compliance measures for aviation security.",
      },
      {
        id: 3,
        courseHeading: "Threat Awareness and Response",
        courseSubHeadingInfo:
          "Gain insights into identifying and responding to potential threats in aviation.",
      },
    ],
  },
    ...
    courseContents: [
      {
        ...
        courseSubHeadingInfo:
          "Learn the basics of dangerous goods classification, identification, and transport.",
      },
      {
        id: 2,
        courseHeading: "International Regulations and Compliance",
        courseSubHeadingInfo:
          "Master the international safety regulations that govern the transportation of dangerous goods by air.",
      },
      {
        id: 3,
        courseHeading: "Handling and Safety Protocols",
        courseSubHeadingInfo:
          "Understand how to safely handle dangerous goods and respond to incidents involving hazardous materials.",
      },
      {
        id: 4,
        courseHeading: "Labeling and Documentation",
        courseSubHeadingInfo:
          "Learn about the necessary labels and documents required for the transport of dangerous goods.",
      },
    ],
  },

  {
    id: 25,
    courseName: "Airport Operations",
    image: "/images/CourseImage/11.webp",
    ...
    courseContents: [
      {
        ...
        courseHeading: "Introduction to Airport Operations",
        courseSubHeadingInfo:
          "Learn the basics of airport operations management, covering both airside and landside activities.",
      },
      {
        id: 2,
        courseHeading: "Ground Handling Procedures",
        courseSubHeadingInfo:
          "Understand the procedures involved in ground handling services, including baggage handling and aircraft servicing.",
      },
      {
        id: 3,
        courseHeading: "Airport Safety Protocols",
        courseSubHeadingInfo:
          "Master the safety standards and protocols required for airport operations.",
      },
      {
        id: 4,
        courseHeading: "Airside and Landside Operations",
        courseSubHeadingInfo:
          "Learn how to manage both airside and landside operations for efficient airport management.",
      },
      {
        id: 5,
        courseHeading: "Airport Systems and Technology",
        courseSubHeadingInfo:
          "Explore the use of airport management systems and technologies for smooth operations and passenger management.",
      },
      {
        id: 6,
        courseHeading: "Civil Aviation Regulations",
        courseSubHeadingInfo:
          "Gain insights into civil aviation regulations and how they apply to airport operations.",
      },
    ],
  },
  {
    id: 26,
    courseName:
      "Irembo Services, Tax Declaration, Visa Application Assistance, EBM, and Microsoft Office Courses",
    image: "/images/CourseImage/24.jpg",
    imageAlt: "Irembo Services, Tax Declaration, EBM, and Microsoft Office",
    category: "ICTSkills",
    subCategory: "iremboTaxAndVisa",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 75,
    lastUpdated: "Any Time",
    availability: "On Campus",
    ...
    teacher: {
      ...
      bio: "With over 4 years of experience in the design industry, Hodal is a UI/UX expert who specializes in creating user-centered designs and Full-stack Web Developer for a variety of platforms and businesses.",
  ...
  },
  {
    ...
    category: "ICTSkills",
    subCategory: "webDesignAndWebDev",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 75,
    lastUpdated: "Any Time",
    availability: "On Campus",
  ...
  },
  {
    ...
    image: "/images/CourseImage/24.jpg",
    imageAlt: "Introduction to Web Development: HTML, CSS, and JavaScript",
    category: "ICTSkills",
    subCategory: "webDesignAndWebDev",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 75,
    ...
    aboutCourses: [
      "Learn how to structure web pages using HTML, creating semantic and accessible content.",
      "Understand the fundamentals of CSS to style web pages, including layout, colors, typography, and responsive design.",
      "Get started with JavaScript, including DOM manipulation, event handling, and basic programming concepts.",
      "Develop skills in building responsive, mobile-friendly websites using CSS frameworks like Tailwind CSS.",
      "Create interactive web pages using JavaScript, including animations and form handling.",
      "Learn how to debug code and troubleshoot common web development issues.",
    ],

    benefitsOfTheCourse: [
      "Acquire fundamental skills in HTML, CSS, and JavaScript for building modern websites.",
      "Build and style your own web projects, gaining hands-on experience in web development.",
      "Understand how to create responsive designs that work across different devices and screen sizes.",
      "Prepare for entry-level roles in web development, including front-end development.",
      "Learn how to use web development tools and frameworks, including code editors and version control systems like Git.",
      "Receive a local certificate upon successful completion, validating your skills in basic web development.",
      "Get insights into best practices for writing clean, maintainable code.",
    ],

    courseContents: [
      {
        id: 1,
        courseHeading: "Introduction to Web Development",
        courseSubHeadingInfo:
          "Understand the basics of how the web works, including browsers, servers, and how web pages are rendered.",
      },
      {
        id: 2,
        courseHeading: "HTML Fundamentals",
        courseSubHeadingInfo:
          "Learn how to structure content on the web using HTML, covering elements, attributes, forms, tables, and semantic HTML.",
      },
      {
        id: 3,
        courseHeading: "CSS for Styling and Layout",
        courseSubHeadingInfo:
          "Understand how to style web pages using CSS, including colors, fonts, box model, layout techniques, and responsive design.",
      },
      {
        id: 4,
        courseHeading: "JavaScript Basics",
        courseSubHeadingInfo:
          "Get introduced to JavaScript programming, including variables, data types, loops, conditionals, functions, and events.",
      },
      {
        id: 5,
        courseHeading: "Building Interactive Web Pages",
        courseSubHeadingInfo:
          "Learn how to add interactivity to websites using JavaScript, including DOM manipulation and event handling.",
      },
      {
        id: 6,
        courseHeading: "Responsive Design and CSS Frameworks",
        courseSubHeadingInfo:
          "Understand the principles of responsive design and learn how to use frameworks like Tailwind CSS to build mobile-friendly websites.",
      },
      {
        id: 7,
        courseHeading: "Final Exam and Certification",
  ...
  },
  {
    id: 29,
    courseName:
      "Advanced Web Development with ReactJS, Tailwind CSS, and GraphQL",
    image: "/images/CourseImage/24.jpg",
    imageAlt: "Introduction to Web Development: HTML, CSS, and JavaScript",
    category: "ICTSkills",
    subCategory: "webDesignAndWebDev",
  ...
  },
  {
    id: 30,
    courseName:
      "Internship in Aviation Industry: Air Ticketing and Hotel Booking",
    image: "/images/CourseImage/24.jpg",
    imageAlt:
      "Practical Internship in Air Ticketing and Hotel Booking Services",
    category: "internship",
    subCategory: "Aviation Industry Training",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 75,
    lastUpdated: "Any Time",
    availability: "On Campus",
    ...
    teacher: {
      name: "Mutoni Ange",
      profilePicture: "/images/teamMember/Ange.png",
      bio: "With over 4 years of experience in the aviation industry, Mutoni Ange is a dedicated professional who specializes in delivering exceptional service and ensuring safety and efficiency in airline operations. Her expertise spans customer service, operational support, and regulatory compliance, making her an asset to any airline or aviation service provider",
      email: "angelmutoni173@gmail.com",
      whatSapp: "+250785187514",
      facebook: "",
      instagram: "M__angel_1",
      linkedIn: "Mutoni angel",
      twitter: "Mutoni angel",
    },
    aboutCourses: [
      "Understand the fundamentals of air ticketing, including fare rules, ticket issuance, and reservation systems.",
      "Learn how to use Global Distribution Systems (GDS) like Amadeus, Sabre, and Galileo for managing reservations.",
      "Master the process of hotel booking, including room reservation, check-in, and customer service protocols.",
      "Develop essential skills in customer support, managing client requests, and troubleshooting reservation issues.",
      "Gain insights into the aviation and hospitality industry's best practices and standards.",
      "Learn how to effectively communicate with customers and provide exceptional service across different platforms.",
    ],

    benefitsOfTheCourse: [
      "Gain practical experience with industry-standard reservation systems used by airlines and travel agencies worldwide.",
      "Develop essential customer service skills, focusing on communication, problem-solving, and client management.",
      "Learn fare calculations, ticket issuance, and rebooking procedures for air travel.",
      "Understand the complete process of hotel booking, from reservation to check-out, including handling special requests.",
      "Receive an Internship Certificate that validates your skills and enhances your career prospects in aviation and hospitality.",
      "Get exposure to real-world scenarios through practical assignments and project work.",
      "Be prepared for career opportunities in airlines, travel agencies, tour operators, and hotel management.",
    ],

    courseContents: [
      {
        id: 1,
        courseHeading: "Introduction to Air Ticketing",
        courseSubHeadingInfo:
          "Learn the basics of airline ticketing, including understanding fare classes, ticket types, and industry terminologies.",
      },
      {
        id: 2,
        courseHeading: "Global Distribution Systems (GDS)",
        courseSubHeadingInfo:
          "Get hands-on experience with GDS platforms such as Amadeus, Sabre, and Galileo, learning how to book, modify, and cancel reservations.",
      },
      {
        id: 3,
        courseHeading: "Customer Service in Air Ticketing",
        courseSubHeadingInfo:
          "Develop communication skills to handle customer inquiries, special requests, and complaint resolutions.",
      },
      {
        id: 4,
        courseHeading: "Hotel Booking Procedures",
        courseSubHeadingInfo:
          "Understand the hotel booking process, from room selection to customer check-in and check-out services.",
      },
      {
        id: 5,
        courseHeading: "Fare Calculation and Ticket Issuance",
        courseSubHeadingInfo:
          "Learn to calculate fares, issue tickets, and manage rebookings and refunds according to airline policies.",
      },
      {
        id: 6,
        courseHeading: "Managing Group Reservations",
        courseSubHeadingInfo:
          "Explore how to handle group travel bookings and coordinate with hotels for group accommodations.",
      },
      {
        id: 7,
        courseHeading: "Practical Assignments & Projects",
        courseSubHeadingInfo:
          "Work on projects that involve handling customer queries, making reservations, and managing booking systems.",
      },
      {
        id: 8,
  ...
  },
  {
    id: 31,
    courseName:
      "Comprehensive Web Design, Web Development, and ICT Technologies",
    image: "/images/CourseImage/24.jpg",
    imageAlt: "Web Design and Development Course with AI Tools Integration",
    category: "internship",
    subCategory: "Aviation Industry Training",
    link: "https://forms.gle/jhaZiEKfD4y52uLH6",
    numberOfStudents: 75,
    ...
    aboutCourses: [
      "Understand the core principles of web design, including UI/UX design, color theory, and typography.",
      "Learn front-end web development with HTML, CSS, JavaScript, and popular frameworks like ReactJS and Angular.",
      "Master back-end development using Node.js, Express, and MongoDB for building robust and scalable web applications.",
      "Explore responsive design techniques to ensure websites work seamlessly across devices.",
      "Get hands-on experience with AI tools such as ChatGPT and TensorFlow, integrating smart functionalities into web solutions.",
      "Understand cloud computing basics and how to deploy web applications using cloud platforms like AWS and Azure.",
    ],

    benefitsOfTheCourse: [
      "Gain expertise in web design and development, from creating responsive layouts to building dynamic web applications.",
      "Develop skills in integrating AI tools to automate tasks and enhance user experiences on websites.",
      "Learn how to deploy and manage web applications on cloud platforms for better scalability and performance.",
      "Receive an International Certificate validating your skills in web development, AI integration, and ICT technologies.",
      "Work on real-world projects and assignments that simulate industry scenarios, preparing you for a tech career.",
      "Stay updated with the latest trends in web development and emerging technologies, keeping your skills relevant.",
      "Gain the ability to work as a full-stack developer, web designer, or AI integration specialist.",
    ],

    courseContents: [
      {
        id: 1,
        courseHeading: "Introduction to Web Design",
        courseSubHeadingInfo:
          "Learn the basics of web design, covering color schemes, typography, and user interface principles.",
      },
      {
        id: 2,
        courseHeading: "HTML, CSS, and JavaScript Essentials",
        courseSubHeadingInfo:
          "Master the foundational languages for front-end web development, creating engaging and interactive web pages.",
      },
      {
        id: 3,
        courseHeading: "Front-End Frameworks: ReactJS & TypeScript",
        courseSubHeadingInfo:
          "Understand how to build dynamic web applications using popular frameworks like ReactJS and Angular.",
      },
      {
        id: 4,
        courseHeading: "Back-End Development with Node.js, Express & GraphQL",
        courseSubHeadingInfo:
          "Learn to develop server-side logic, manage databases, and create RESTful APIs for web applications.",
      },
      {
        id: 5,
        courseHeading: "Responsive Design & Mobile-First Approach",
        courseSubHeadingInfo:
          "Explore techniques to make your websites mobile-friendly, ensuring optimal performance on all devices.",
      },
      {
        id: 6,
        courseHeading: "Introduction to AI Tools for Web Development",
        courseSubHeadingInfo:
          "Discover how to integrate AI functionalities into your websites, using tools like ChatGPT and TensorFlow.",
      },
      {
        id: 7,
        courseHeading: "Machine Learning Basics & Data Processing",
        courseSubHeadingInfo:
          "Understand core concepts of machine learning, data processing, and how they apply to web development.",
      },
      {
        id: 8,
        courseHeading: "Cloud Computing & Web Application Deployment",
        courseSubHeadingInfo:
          "Learn how to deploy web applications on cloud platforms such as AWS and Azure, ensuring scalability and reliability.",
      },
      {
        id: 9,
        courseHeading: "Real-World Projects & Assignments",
        courseSubHeadingInfo:
          "Work on projects that involve building full-stack web applications, integrating AI tools, and deploying on cloud platforms.",
      },
      {
        id: 10,
        courseHeading: "Final Revision and Get Certification",
